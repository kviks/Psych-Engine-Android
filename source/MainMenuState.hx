...
{
	public static var abobaEngineVersion:String = '1.0.0 release (PE: 0.4.2)'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "ABOBA Engine: v" + abobaEngineVersion, 12);
